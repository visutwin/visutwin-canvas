...
namespace visutwin::canvas
{
    ...
    {
    public:
        static constexpr int kMaxTextureSlots = 36;  // Slots 0-35; 6 = directional shadow (slot 0), 35 = directional shadow (slot 1); 11-12 = spot shadow, 15-16 = omni shadow cubemaps, 17 = height map, 18 = SSAO, 19 = lightmap, 20-21 = LTC area-light LUTs, 22 = scene color grab, 23 = detail normal, 24 = reflection probe cubemap, 25 = SSR scene depth grab, 26 = clustered spot-shadow atlas array, 27-28 = spot light cookies, 29-30 = omni light cookie cubemaps, 31 = gloss map, 32 = thickness map, 33 = refraction map, 34 = opacity map
