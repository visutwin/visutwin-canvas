...
// Copyright 2025-2026 Arnis Lektauers
    ...
    VT_FEATURE_DISPLACEMENT || VT_FEATURE_ATMOSPHERE
    // DEVIATION: feature chunks are staged behind compile-time toggles and will be ported incrementally.
    // NOTE: VT_FEATURE_VERTEX_COLORS, VT_FEATURE_CLEARCOAT, VT_FEATURE_LIGHT_CLUSTERING, VT_FEATURE_PARALLAX, VT_FEATURE_ANISOTROPY, VT_FEATURE_TRANSMISSION, VT_FEATURE_SSAO, VT_FEATURE_SHEEN, VT_FEATURE_IRIDESCENCE removed — now fully implemented.
#endif
